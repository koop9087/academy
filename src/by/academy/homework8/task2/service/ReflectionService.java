...
public class ReflectionService {
    ...
    public void callAllReflectService(){
        printAllReflectMethods();
        printReflectMethod();
        printAllReflectFields();
        printReflectField();
        printAllReflectDeclaredMethods();
        printReflectDeclaredMethods();
        printAllReflectDeclaredFields();
        printReflectDeclaredFields();
        printPersonClassFields();
        printUserClassFields();
        printInvokeToString();
    }
}
